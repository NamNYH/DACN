    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Ebus Booking</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
          ...
          <li>
                    ...
                    <li>
                        <a href="availability_view.php"><i class="fa fa-check-circle"></i>Thông tin</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 <div class="row">
                 ...
                 <!-- /. ROW  -->
				 <footer><strong><p><center>Ebus được phát triển bởi: NamNYH</p></center></strong></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
