...
$amount = "10000";
$orderId = time() ."";
$returnUrl = "http://localhost:8000/busbooking/thanh_toan_momo/PayMoMo/result.php";
$notifyurl = "http://localhost:8000/busbooking/thanh_toan_momo/PayMoMo/ipn_momo.php";
